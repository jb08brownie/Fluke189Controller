...
This project grew out of reverse-engineering the Fluke 189's undocumented serial protocol, since Fluke's own software (FlukeView) is dated, Windows-only in practice, and doesn't offer much flexibility. The full writeup of how the protocol was reverse-engineered, and how the IR interface cable was built, is on my blog: link to blog post.
